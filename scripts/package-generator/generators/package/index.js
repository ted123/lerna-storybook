...
module.exports = class extends Generator {
  ...
  default() {}
  writing() {
    this.answers.name = _.upperFirst(this.answers.name);
    this.fs.copyTpl(
    ...
    this.fs.copyTpl(
      this.templatePath(`stories/Placeholder.stories.mdx`),
      this.destinationPath(
        `packages/${this.answers.name}/stories/${this.answers.name}.stories.mdx`
      ),
      {
        name: this.answers.name,
        description: this.answers.description
