...
describe('initial test for paginator component', () => {
  ...
  it('should go to the next Page', () => {
    ...
    const content = screen.getByText('6');
    expect(content).toEqual(content);
  });
  it('should click the page numbers', () => {
    render(
      <Pagination
        handlePagination={handlePagination}
        totalDataLength={pageData.length}
    ...
    fireEvent.click(screen.getByLabelText(/3/i));
  ...
  it('should go to last page', () => {
    ...
    const content = screen.getByText(/40/i);
    expect(content).toEqual(content);
  });
